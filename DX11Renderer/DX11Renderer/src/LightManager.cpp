...
namespace gfx
{
	LightManager::LightManager(const GraphicsDevice& gfx, std::shared_ptr<RendererList> pRendererList)
	{
		...
		UINT lightIdx = 0u;
		m_pLights.emplace_back(std::make_shared<PointLight>(gfx, lightIdx++, true, true, pLightModelAsset, dx::XMFLOAT3(0.f, 5.4f, 0.f), dx::XMFLOAT3(1.f, 1.f, 1.f), 3.f, 3.f, 5.f));
