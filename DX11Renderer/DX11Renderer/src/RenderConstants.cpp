...
namespace gfx
{
	...
	std::unordered_map<RenderPassType, std::string> RenderPassConstants::m_renderPassNameByEnum
	{
		...
		{ RenderPassType::DoFPrefilterSubpass,				"DoFPrefilterPass" },
		{ RenderPassType::DoFFarBlurSubpass,				"DoFFarBlurPass" },
		{ RenderPassType::DoFNearBlurSubpass,				"DoFNearBlurPass" },
		{ RenderPassType::DoFCompositeSubpass,				"DoFCompositePass" },
		{ RenderPassType::BloomPrefilterSubpass,		    "BloomPrefilterPass" },
		{ RenderPassType::BloomSeparableBlurSubpass,		"BloomSeparableBlurPass" },
		{ RenderPassType::BloomCombineSubpass,		        "BloomCombinePass" },
	...
	std::unordered_map<RenderPassType, std::size_t> RenderPassConstants::m_renderPassHashByEnum
	{
		...
		{ RenderPassType::DoFPrefilterSubpass,				std::hash<std::string>{}("DoFPrefilterPass") },
		{ RenderPassType::DoFFarBlurSubpass,				std::hash<std::string>{}("DoFFarBlurPass") },
		{ RenderPassType::DoFNearBlurSubpass,				std::hash<std::string>{}("DoFNearBlurPass") },
		{ RenderPassType::DoFCompositeSubpass,				std::hash<std::string>{}("DoFCompositePass") },
		{ RenderPassType::BloomPrefilterSubpass,		    std::hash<std::string>{}("BlurPyramidRenderPass") },
		{ RenderPassType::BloomSeparableBlurSubpass,		std::hash<std::string>{}("BloomSeparableBlurPass") },
		{ RenderPassType::BloomCombineSubpass,		        std::hash<std::string>{}("BloomCombinePass") },
	...
	std::unordered_map<std::size_t, RenderPassType> RenderPassConstants::m_renderPassEnumByHash
	{
		...
		{ std::hash<std::string>{}("DoFPrefilterPass"),				RenderPassType::DoFPrefilterSubpass },
		{ std::hash<std::string>{}("DoFFarBlurPass"),				RenderPassType::DoFFarBlurSubpass },
		{ std::hash<std::string>{}("DoFNearBlurPass"),				RenderPassType::DoFNearBlurSubpass },
		{ std::hash<std::string>{}("DoFCompositePass"),				RenderPassType::DoFCompositeSubpass },
		{ std::hash<std::string>{}("BloomPrefilterPass"),			RenderPassType::BloomPrefilterSubpass },
		{ std::hash<std::string>{}("BloomSeparableBlurPass"),		RenderPassType::BloomSeparableBlurSubpass },
		{ std::hash<std::string>{}("BloomCombinePass"),		        RenderPassType::BloomCombineSubpass },
