...
namespace gfx
{
	...
	std::unordered_map<RenderPassType, std::string> RenderPassConstants::m_renderPassNameByEnum
	{
		...
		{ RenderPassType::DoFPrefilterPass,				"DoFPrefilterPass" },
		{ RenderPassType::DoFFarBlurPass,				"DoFFarBlurPass" },
		{ RenderPassType::DoFNearBlurPass,				"DoFNearBlurPass" },
		{ RenderPassType::DoFCompositePass,				"DoFCompositePass" },
	...
	std::unordered_map<RenderPassType, std::size_t> RenderPassConstants::m_renderPassHashByEnum
	{
		...
		{ RenderPassType::DoFPrefilterPass,				std::hash<std::string>{}("DoFPrefilterPass") },
		{ RenderPassType::DoFFarBlurPass,				std::hash<std::string>{}("DoFFarBlurPass") },
		{ RenderPassType::DoFNearBlurPass,				std::hash<std::string>{}("DoFNearBlurPass") },
		{ RenderPassType::DoFCompositePass,				std::hash<std::string>{}("DoFCompositePass") },
	...
	std::unordered_map<std::size_t, RenderPassType> RenderPassConstants::m_renderPassEnumByHash
	{
		...
		{ std::hash<std::string>{}("DoFPrefilterPass"),				RenderPassType::DoFPrefilterPass },
		{ std::hash<std::string>{}("DoFFarBlurPass"),				RenderPassType::DoFFarBlurPass },
		{ std::hash<std::string>{}("DoFNearBlurPass"),				RenderPassType::DoFNearBlurPass },
		{ std::hash<std::string>{}("DoFCompositePass"),				RenderPassType::DoFCompositePass },
		{ std::hash<std::string>{}("BloomPrefilterPass"),			RenderPassType::BloomPrefilterPass },
