...
namespace gfx
{
	ModelImporter::ModelImportSettings ModelImporter::GetImportSettings(Graphics& gfx, const char * assetFilename)
	{
	...
	size_t ModelImporter::GetAttributeCt(Graphics & gfx, tinygltf::Model & model, int accessorIdx)
	{
		const auto accessor = model.accessors[accessorIdx];
		return accessor.count;
	}

	std::pair<int, size_t> ModelImporter::GetAttributeBufferAccess(Graphics & gfx, tinygltf::Model & model, int accessorIdx, size_t byteCt)
	{
	...
	std::shared_ptr<ModelAsset> ModelImporter::LoadGLTF(Graphics& gfx, const char * assetFilename)
	{
