...
namespace gfx
{
	...
	public:
		...
		PixelShader(const GraphicsDevice& gfx, const char* path, const std::string& shaderName);
	...
	public:
		...
		static std::shared_ptr<PixelShader> Resolve(const GraphicsDevice& gfx, const char* path, const char* shaderName);
